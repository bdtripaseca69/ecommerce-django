...
class Order(models.Model):
    ...
    #funcion que permita devolver el nombre completo y la direccion en el payments.html
    def full_name(self):
...
class OrderProduct(models.Model):
    ...
    #registro de todos los prooductos que vienen desde el carrito una vez que se  haya echo el pago
